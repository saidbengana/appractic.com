...
import { TwitterGallery } from "@/components/ui/provider-gallery/twitter/twitter-gallery";
...
interface PostPreviewTwitterProps {
  name: string;
  username: string;
  image: string;
  content: Array<{
    ...
    <Panel className={cn("relative", className)}>
      <div className="flex items-start">
        ...
        <div className="w-full">
          ...
          <TwitterGallery media={mainContent.media} />
